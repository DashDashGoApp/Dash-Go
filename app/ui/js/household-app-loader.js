...
function loadChoreWheelAssets(){
  ...
  _choreWheelLoading=Promise.all([appendLazyStyle("ui/chore-wheel.css?v="+(CONFIG.version||"1.5.5"),"chorewheel"),appendLazyScript("ui/chore-wheel-core.js?v="+(CONFIG.version||"1.5.5"),"chorewheel-core")]).then(()=>appendLazyScript("ui/chore-wheel.js?v="+(CONFIG.version||"1.5.5"),"chorewheel-script"));
...
function loadFamilyBoardAssets(){
  ...
  _familyBoardLoading=Promise.all([appendLazyStyle("ui/family-board.css?v="+(CONFIG.version||"1.5.5"),"familyboard"),appendLazyScript("ui/family-board-core.js?v="+(CONFIG.version||"1.5.5"),"familyboard-core")]).then(()=>appendLazyScript("ui/family-board.js?v="+(CONFIG.version||"1.5.5"),"familyboard-script"));
...
function loadMaintenanceAssets(){
  ...
  _maintenanceLoading=Promise.all([appendLazyStyle("ui/maintenance.css?v="+(CONFIG.version||"1.5.5"),"maintenance"),appendLazyScript("ui/maintenance-core.js?v="+(CONFIG.version||"1.5.5"),"maintenance-core")]).then(()=>appendLazyScript("ui/maintenance.js?v="+(CONFIG.version||"1.5.5"),"maintenance-script"));
...
function loadRoutinesAssets(){
  ...
  _routinesLoading=Promise.all([appendLazyStyle("ui/routines.css?v="+(CONFIG.version||"1.5.5"),"routines"),appendLazyScript("ui/routines-core.js?v="+(CONFIG.version||"1.5.5"),"routines-core")]).then(()=>appendLazyScript("ui/routines.js?v="+(CONFIG.version||"1.5.5"),"routines-script"));
