...
function loadChoreWheelAssets(){
  ...
  _choreWheelLoading=Promise.all([appendLazyStyle("ui/chore-wheel.css?v="+(CONFIG.version||"1.5.0-beta.40"),"chorewheel"),appendLazyScript("ui/chore-wheel-core.js?v="+(CONFIG.version||"1.5.0-beta.40"),"chorewheel-core")]).then(()=>appendLazyScript("ui/chore-wheel.js?v="+(CONFIG.version||"1.5.0-beta.40"),"chorewheel-script"));
...
function loadFamilyBoardAssets(){
  ...
  _familyBoardLoading=Promise.all([appendLazyStyle("ui/family-board.css?v="+(CONFIG.version||"1.5.0-beta.40"),"familyboard"),appendLazyScript("ui/family-board-core.js?v="+(CONFIG.version||"1.5.0-beta.40"),"familyboard-core")]).then(()=>appendLazyScript("ui/family-board.js?v="+(CONFIG.version||"1.5.0-beta.40"),"familyboard-script"));
...
function loadMaintenanceAssets(){
  ...
  _maintenanceLoading=Promise.all([appendLazyStyle("ui/maintenance.css?v="+(CONFIG.version||"1.5.0-beta.40"),"maintenance"),appendLazyScript("ui/maintenance-core.js?v="+(CONFIG.version||"1.5.0-beta.40"),"maintenance-core")]).then(()=>appendLazyScript("ui/maintenance.js?v="+(CONFIG.version||"1.5.0-beta.40"),"maintenance-script"));
...
function loadRoutinesAssets(){
  ...
  _routinesLoading=Promise.all([appendLazyStyle("ui/routines.css?v="+(CONFIG.version||"1.5.0-beta.40"),"routines"),appendLazyScript("ui/routines-core.js?v="+(CONFIG.version||"1.5.0-beta.40"),"routines-core")]).then(()=>appendLazyScript("ui/routines.js?v="+(CONFIG.version||"1.5.0-beta.40"),"routines-script"));
