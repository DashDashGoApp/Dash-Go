...
need "$INSTALL" 'OPT_TODO=12' 'stable Microsoft To Do menu identity'
need "$INSTALL" '"  ${OPT_TODO}) Microsoft To Do / Graph local Lists, client ID, and Azure CLI app setup"' 'Microsoft To Do / Graph menu entry'
need "$INSTALL" '"$OPT_TODO") DO_APP_SETUP=1;;' 'Microsoft To Do / Graph menu dispatch'
...
echo 'PASS: installer Microsoft To Do / Graph setup stays discoverable, local-first, and Microsoft opt-in'
