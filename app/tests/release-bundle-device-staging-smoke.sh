...
need "$INSTALLER" 'snapshot_canonical_installer(){' 'canonical installer snapshot helper'
need "$INSTALLER" 'install_canonical_installer(){' 'canonical installer refresh helper'
need "$INSTALLER" 'install_release_payload "$payload" "$version" "" "$INSTALLER_SOURCE_DIR/install.sh"' 'bundle installer handoff into payload transaction'
