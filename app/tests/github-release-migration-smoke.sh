...
need "$INSTALLER" 'find_release_bundle_installer(){' 'release-bundle installer resolver'
need "$INSTALLER" 'snapshot_canonical_installer(){' 'canonical installer rollback snapshot'
need "$INSTALLER" 'install_canonical_installer(){' 'canonical installer refresh'
need "$INSTALLER" 'restore_canonical_installer "$stage"' 'canonical installer rollback restoration'
...
need "$INSTALLER" 'install_release_payload "$payload" "$version" "" "$INSTALLER_SOURCE_DIR/install.sh"' 'local bundle canonical installer handoff'
