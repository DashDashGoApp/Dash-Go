...
require_inst 'find_release_bundle_installer'
require_inst 'snapshot_canonical_installer'
require_inst 'install_canonical_installer'
require_inst 'restore_canonical_installer'
